    ...
    <Section crosses id="how-to-use">
      <div className="container ">
        ...
        <div className="relative ">
          <div className="z-1 flex relative items-center h-[39rem] mb-5 p-8 border border-n-8 rounded-3xl  overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <ul className="body-2">
                {brainwaveServices.map((item, index) => (
                  <li
                    className="flex items-start border-t py-4 border-n-6"
                    key={index}
                  >
            ...
            <Generating className="absolute left-4 bottom-4 right-4 border border-n-1/10 lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2" />
          </div>
                    ...
                    <li
                      ...
                      className={` flex rounded-2xl items-center justify-center ${
                        index === 2
                          ...
                          : "flex w-10 h-10 bg-n-6 md:-15 md:h-15"
                      }`}
                    >
                      <div
                        className={
